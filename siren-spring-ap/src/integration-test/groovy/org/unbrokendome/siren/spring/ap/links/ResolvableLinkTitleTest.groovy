...
class ResolvableLinkTitleTest extends Specification implements CompilerTest, RequestContextTest {
    ...
    def "Should generate link title for controller method"() {
        ...
        and:
            messageSource.addMessage('home.title', Locale.ENGLISH, 'resolved home title')
        ...
        then:
            link.title == 'resolved home title'
    }
}
