...
class LinkWithNamedPathVariableTest extends Specification implements CompilerTest, RequestContextTest {
    ...
    static final String CUSTOMERCONTROLLER_SOURCE = '''
        ...
        public class CustomerController {
            ...
            public RootEntity getCustomer(@PathVariable("id") int customerId) {
