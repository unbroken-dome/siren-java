...
class LinkWithContentTypeTest extends Specification implements CompilerTest, RequestContextTest {
    ...
    static final String HOMECONTROLLER_SOURCE = '''
        ...
        public class HomeController {
            @RequestMapping(value="/", method=RequestMethod.GET, produces="application/vnd.siren+json")
    ...
    def "Should generate link for controller method"() {
        ...
        then:
            link.type == 'application/vnd.siren+json'
    }
}
